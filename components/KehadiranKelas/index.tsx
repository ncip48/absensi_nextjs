...
const KehadiranKelas = ({ title, data }: { title: string; data: any }) => {
  return (
    <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 border border-blue-gray-100 shadow-sm dark:bg-dark-800 dark:border-dark-800 dark:text-white">
      ...
      <div className="py-4">
        <Table
          loading={false}
          items={data}
          heads={["Kelas", "Hadir", "Telat", "Full"]}
          keys={["kelas", "jumlahHadir", "jumlahTerlambat", "jumlahFull"]}
          noAction
          noStatus
          noPagination
          wFull
